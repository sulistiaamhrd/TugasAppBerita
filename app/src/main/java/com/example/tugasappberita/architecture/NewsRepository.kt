...
import com.example.tugasappberita.retrofit.NewsApi
import com.example.tugasappberita.retrofit.NewsDataFromJson
import com.example.tugasappberita.retrofit.RetrofitHelper
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers.IO
import kotlinx.coroutines.launch
import org.json.JSONException
import com.example.tugasappberita.BuildConfig
...
class NewsRepository {
    ...
    fun getNewsApiCall(category: String?): MutableLiveData<List<NewsModel>> {
        ...
        val call = RetrofitHelper.getInstance().create(NewsApi::class.java)
            .getNews("id", category, BuildConfig.API_KEY) //put your api key here
